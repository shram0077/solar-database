...
class InvoicePrintHawala extends StatefulWidget {
  final String htmlContent;

  const InvoicePrintHawala({super.key, required this.htmlContent});

  @override
  State<InvoicePrintHawala> createState() => _InvoicePrintHawalaState();
}

class _InvoicePrintHawalaState extends State<InvoicePrintHawala> {
