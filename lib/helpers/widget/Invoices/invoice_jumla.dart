...
class InvoicePrintJumla extends StatefulWidget {
  final String htmlContent;

  const InvoicePrintJumla({super.key, required this.htmlContent});

  @override
  State<InvoicePrintJumla> createState() => _InvoicePrintJumlaState();
}

class _InvoicePrintJumlaState extends State<InvoicePrintJumla> {
